...
#include "Vector4.h"
#include "Mesh.h"
#include "../CSC8506 Team Project/Material.h"
#include <vector>
...
public:
	...
	SceneNode* getChildrenAtIndex(int index){ return children[index]; }

	static bool		CompareByCameraDistance(SceneNode*a,SceneNode*b) ;
	static bool		CompareByZ(SceneNode*a,SceneNode*b) ;

	//02/02/15
	static void SetDefaultShader(Shader* s) { defaultShader = s; }
	Shader*			GetShader() const { return shader; }
	void			SetShader(Shader* s) { shader = s; }

	//06/02/15
	static void SetDefaultMaterial(Material* m) { defaultMaterial = m; }
