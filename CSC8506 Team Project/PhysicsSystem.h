...
public:
	...
	void		NarrowPhaseHelper(PhysicsNode* left, PhysicsNode* right);
	...
	//statics for the renderer
	static int numUpdates;
	static int numNodes;
	static int numNodesRest;
	static int numCollisions;
	static int numUpdatesPerSec;
	static int numUpdatesTotal;
