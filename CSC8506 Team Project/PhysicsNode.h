...
#define LINEAR_VELOCITY_DAMP 0.998f
...
public:
	...
	void SetRestable(bool b) { m_restable = b; }
	void SetRest(bool b) { m_atRest = b; }
	...
	std::vector<PhysicsNode*> children;

	void setMoveable(bool val) { moveable = val; }
